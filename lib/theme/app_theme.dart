...
class AppTheme {
  ...
  static const Color secondaryVariantLight =
      Color(0xFF357A8F); // Darker supporting blue
  static const Color accentLight = Color(0xFFE8A547); // Warm gold
  static const Color backgroundLight = Color(0xFFE3E1DF); // Clean background
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white cards
  static const Color errorLight = Color(0xFFDC2626); // Clear error red
  static const Color successLight = Color(0xFF10B981); // Clear green
  static const Color warningLight = Color(0xFFF59E0B); // Attention orange
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color onSecondaryLight = Color(0xFFFFFFFF);
  static const Color onBackgroundLight = Color(0xFF1F2937); // Near-black text
  static const Color onSurfaceLight = Color(0xFF1F2937); // Near-black text
  ...
  static const Color secondaryDark =
      Color(0xFFE8A547); // Warm gold as secondary
  static const Color secondaryVariantDark = Color(0xFFD4933A); // Darker gold
  static const Color accentDark = Color(0xFF1B365D); // Deep blue as accent
  ...
  static const Color errorDark = Color(0xFFEF4444); // Lighter error red
  static const Color successDark = Color(0xFF22C55E); // Lighter green
  static const Color warningDark = Color(0xFFFBBF24); // Lighter orange
  static const Color onPrimaryDark = Color(0xFFFFFFFF);
  static const Color onSecondaryDark = Color(0xFF000000);
  static const Color onBackgroundDark = Color(0xFFF8FAFC); // Light text
  static const Color onSurfaceDark = Color(0xFFF8FAFC); // Light text
  static const Color onErrorDark = Color(0xFFFFFFFF);

  // Card and dialog colors
  static const Color cardLight = Color(0xFFFFFFFF); // Pure white
  static const Color cardDark = Color(0xFF1E293B); // Dark surface
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Label styles - Roboto for interface text
